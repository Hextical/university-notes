\chapter{Week 2 --- Experiments with Two Conditions}
...
\begin{itemize}
      ...
      \item Using the observed data, we test hypotheses of the form:
            ...
            \end{itemize}
\end{itemize}
\subsection*{$ t $-tests, $ F $-tests, and an Example}
...
\begin{itemize}
      ...
      \item Using the observed data, we test hypotheses of the form:
            ...
            \end{itemize}
\end{itemize}
\subsection*{$ Z $-tests and an Example}
\begin{Statistical_Test}{$ \symbf{Z} $-test for Proportions}{}
      ...
      \end{itemize}
\end{Statistical_Test}
\begin{Example}{Optimizing Optimizely}{}
      \begin{itemize}
