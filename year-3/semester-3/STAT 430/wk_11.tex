...
\begin{itemize}
      ...
      \item Because only $2^4=16$ conditions were used, we can only fit a model with 16 regression coefficients. In
            ...
            interactions, 4 three-factor interactions and 1 four-factor interaction as seen in~\Cref{fig:winefig1}.
            \begin{figure}[!htbp]
                  \centering
                  \caption{$ 2^4 $ factorial experiment in the wine example.}\label{fig:winefig1}
                  \includegraphics[width=0.5\textwidth]{winefig1.pdf}
            \end{figure}
      ...
      \item The same model summary from~\Cref{fig:winefig1} is shown in~\Cref{fig:winefig2}, but this time with factors E, F, G and H
            ...
            \begin{figure}[!htbp]
                  ...
                  \includegraphics[width=0.5\textwidth]{winefig2.pdf}
            \end{figure}
            \begin{itemize}[*]
      ...
      \item Examples of such response surfaces (for $ K^\prime=2 $) are visualized in~\Cref{fig:respsurfaces}:
            \begin{figure}[!htbp]
                  ...
                  \begin{subfigure}{0.5\textwidth}
                        \centering
                        \includegraphics[width=.48\linewidth]{plane1.pdf}
                        \includegraphics[width=.48\linewidth]{plane2.pdf}
                        \caption{$\eta=\beta_0+\beta_1x_1+\beta_2x_2$ (Plane)}\label{fig:plane}
                  \end{subfigure}
                  \begin{subfigure}{0.5\textwidth}
                        \centering
                        \includegraphics[width=.48\linewidth]{twplane1.pdf}
                        \includegraphics[width=.48\linewidth]{twplane2.pdf}
                        \caption{$\eta=\beta_0+\beta_1x_1+\beta_2x_2+\beta_{12}x_1x_2$ (Twisted Plane)}\label{fig:twplane}
                  \end{subfigure}
                  \begin{subfigure}{0.5\textwidth}
                        \centering
                        \includegraphics[width=.48\linewidth]{secondorder1.pdf}
                        \includegraphics[width=.48\linewidth]{secondorder2.pdf}
...
\begin{itemize}
      ...
      \item The linear regression model with linear predictor:
            \[ \eta=\beta_0+\beta_1x_1+\beta_2x_2+\beta_{12}x_1x_2+\beta_{\symbfsfup{PQ}}x_{\symbfsfup{PQ}} \]
            was fit. The resulting output is shown in~\Cref{fig:netflixout1}.
            \begin{figure}[!htbp]
                  \centering
                  \includegraphics[width=0.5\textwidth]{out1.pdf}
      ...
      \item To begin the method of steepest descent procedure, we use the aforementioned data to fit the first
            ...
            The model summary is shown in~\Cref{fig:netflixout2}.
            \begin{figure}[!htbp]
                  \centering
                  \includegraphics[width=0.5\textwidth]{out2.pdf}
      ...
      \item Once again we fit a linear regression model with linear predictor:
            \[ \eta=\beta_0+\beta_1x_1+\beta_2x_2+\beta_{12}x_1x_2+\beta_{\symbfsfup{PQ}}x_{\symbfsfup{PQ}} \]
      \item The resulting output is shown in~\Cref{fig:netflixout3}.
            \begin{figure}[!htbp]
                  \centering
                  \includegraphics[width=0.5\textwidth]{out3.pdf}
