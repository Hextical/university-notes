...
\begin{framed}
    ...
    \begin{itemize}
        ...
        \item The question should be quantifiable/measurable and typically stated
              in terms of the measure of interest.
    \end{itemize}
    \begin{Example}{}{}
        \begin{itemize}
...
\begin{framed}
    ...
    should be answered.
    \begin{itemize}
        \item Choose the response variable. This should be dictated by the \textbf{Question} and the measure
              of interest.
        \item Chose the factor(s): brainstorm all factors that might influence the response and make
              decisions about whether and how they will be controlled in the experiment.
              \begin{enumerate}[i]
                  \item \textbf{Design factors}: are factors that we actually manipulate in the experiment.
                        The factors we've discussed in the Nike and Nixon examples are design factors.
                  \item \textbf{Nuisance factors}: are factors that we anticipate will influence
                        the response, but whose effect we don't care to quantify. Instead, we try to eliminate
                        their effects with \emph{blocking}.
                  \item \textbf{Allowed-to-vary factors}: are factors that we \emph{don't control} in an experiment.
                        \begin{itemize}
                            \item Either these factors are unknown to us, or they are known, and
                                  we cannot/choose not to control them. \emph{\hyperref[ex:nixon_ex]{Nixon Example}}:
...
\begin{framed}
    ...
    of the analysis relies on the data being collected correctly. ``Garbage in, garbage out.''
    \begin{itemize}
        \item A/A Test: units are assigned to one of two \emph{identical} conditions.
              \begin{itemize}
                  ...
                  \item Simple Ratio Mismatch Test: check whether the observed sample ratios
...
\begin{framed}
    ...
    \begin{itemize}
        ...
        \item Communicating ``wins'' and ``loses.''
    \end{itemize}
\end{framed}
...
\begin{Definition}{Replication}{}
    ...
    within each experimental conditional and thus corresponds to the situation in which
    more than one unit is assigned to each conditional.
\end{Definition}
\begin{itemize}
