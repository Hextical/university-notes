...
\begin{itemize}
      ...
      \item We calculate the $ p $-value for this test by:
...
\begin{table}[!htbp]
      ...
      \begin{NiceTabular}{|l|c|c|c|c|}
            ...
            \midrule
            Condition & $ \text{SS}_\text{C} $ & $ m-1 $ & $ \text{MS}_\text{C}=\text{SS}_\text{C}/(m-1) $ & \multirow{2}{*}{$ t=\text{MS}_\text{C}/\text{MS}_\text{E} $} \\
...
\begin{itemize}
      ...
      \item To start, let's assume that $ m=2 $, and let's use the \hyperref[ex:optimizely_ex1]{Optimizely experiment}.
            \begin{itemize}
                  ...
                  \item We calculate the $ p $-value for this test by: $ p\text{-value} = \Prob{T\ge t} $ where
                        $ T \sim \chi^2(1) $.
                  \item Returning to the Optimizely example, the \emph{expected} table is~\Cref{optimizely_contingency}.
                        \begin{table}[!htbp]
                              ...
                              \begin{NiceTabular}{cc|cc|c}
                                    ...
                                    \multicolumn{2}{c}{}        & 1                                      & 2                          & \multicolumn{1}{c}{}                                     \\
                                    \cmidrule{2-5}
                                    \multirow{2}{*}{\emph{Conversion}} & Yes                                    & $343.96$                   & $335.04$                   & $679$                       \\
      ...
      \item Let's now extend this for $ m>2 $.
            \begin{itemize}
                  ...
                  \item We calculate the $ p $-value of this test by:
                        $ p\text{-value} = \Prob{T\ge t} $ where $ T \sim \chi^2(m-1) $.
            \end{itemize}
\end{itemize}
\subsection{Example: Nike SB Ads}
\begin{Example}{Nike SB Ads}{}
      \begin{itemize}
            ...
            \item We show each of these 5 videos to $ n_1=5014 $, $ n_2=4971 $, $ n_3=5030 $,
                  $ n_4=5007 $, and $ n_5=4980 $ users, and summarize the results in the table below.
                  \begin{center}
                        \captionsetup{type=table}
                        \captionof{table}{A $ 2\times 5 $ Observed Contingency Table for the Nike Example}
            ...
            \item We multiply $ n_j $ by $ \hat{\pi} $ and $ (1-\hat{\pi}) $ for $ j=1,2,3,4,5 $
                  to get the expected cell frequencies.
                  \begin{center}
                        \captionsetup{type=table}
                        \captionof{table}{A $ 2\times 5 $ Expected Contingency Table for the Nike Example}
                        \begin{NiceTabular}{cc|ccccc|c}
                              \multicolumn{2}{c}{}  & \multicolumn{5}{c}{\emph{Condition}} &                                                                                                                                                                              \\
                              \multicolumn{2}{c}{}  & 1                                      & 2                          & 3                          & 4                          & 5                          & \multicolumn{1}{c}{}                                     \\
                              \cmidrule{2-8}
