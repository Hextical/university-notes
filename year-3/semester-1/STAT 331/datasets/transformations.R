...
summary(lm.log)
plot(lm.log$fitted.values, lm.log$residuals, xlab = "Fitted Values", ylab = "Residuals")
...
plot(lm.loglog$fitted.values, lm.loglog$residuals, xlab = "Fitted Values", ylab = "Residuals")
plot(log(dat$acres), lm.loglog$residuals, xlab = "Fitted Values", ylab = "Residuals")
...
plot(mpf2$fitted.values, mpf2$residuals, xlab = "Fitted Values", ylab = "Residuals")
