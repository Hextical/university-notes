...
plot(rocket$nozzle, mr$residuals, xlab = "Nozzle (1 = large)", ylab = "Residuals")
plot(rocket$propratio, mr$residuals, xlab = "Propellant to fuel ratio", ylab = "Residuals")
