    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \item \begin{enumerate}[label=(\alph*)]
                  \item $ \Prob{X\leqslant 1/3,Y\leqslant 1/2} $.
                        ...
                        Therefore,
                        \begin{align*}
                            \Prob{X\leqslant 1/3,Y\leqslant 1/2}
                            ...
                            \left( e^{-2/3}-1 \right) \right)                                                                       \\
                             ...
                             & \approx 0.1427
                        \end{align*}
                  \item $ \Prob{X\leqslant Y} $. Note that the region
                        is the same as the support. Therefore,
                        \[ \Prob{X\leqslant Y}
                            =\iint\limits_{x\leqslant y}f(x,y)dx\,dy=1 \]
                  \item $ \Prob{X+Y\geqslant 1} $. Note that this region is a
                        bit complicated, so we will consider $ 1-\Prob{X+Y<1}
                            =1-\Prob{X+Y\leqslant 1} $.
