...
\begin{Proposition}{Properties of GARCH}{}
    ...
    \end{enumerate}
\end{Proposition}
\href{https://github.com/Hextical/university-notes/blob/master/year-3/semester-2/STAT%20443/code/8.4%20-%20ARCH%20and%20GARCH%20Update.R}{[R Code] ARCH and GARCH Models}
...
\begin{Remark}{}{}
    ...
    \end{enumerate}
\end{Remark}
\href{https://github.com/Hextical/university-notes/blob/master/year-3/semester-2/STAT%20443/code/8.7%20-%20Identifying%20GARCH%20models.R}{[R Code] Identifying GARCH Models}
