...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in model.frame.default(formula = y \textasciitilde{} typef + sitef, drop.unused.levels = TRUE): variable lengths differ (found for 'typef')}}\begin{alltt}
\hlkwd{summary}\hlstd{(model1)}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in `\$<-.data.frame`(`*tmp*`, fitted.values, value = c(`1` = 0.209776106909185, : replacement has 34 rows, data has 12}}\begin{alltt}
\hlstd{derm.dat}\hlopt{$}\hlstd{rdeviance} \hlkwb{=} \hlkwd{residuals.glm}\hlstd{(model1,} \hlkwc{type} \hlstd{=} \hlstr{"deviance"}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in `\$<-.data.frame`(`*tmp*`, rdeviance, value = c(`1` = -0.64772850316963, : replacement has 34 rows, data has 12}}\begin{alltt}
\hlstd{derm.dat}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in model.frame.default(formula = y \textasciitilde{} typef, drop.unused.levels = TRUE): variable lengths differ (found for 'typef')}}\begin{alltt}
...
\hlstd{model3} \hlkwb{=} \hlkwd{glm}\hlstd{(y} \hlopt{~} \hlstd{sitef,} \hlkwc{family} \hlstd{= poisson)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in model.frame.default(formula = y \textasciitilde{} sitef, drop.unused.levels = TRUE): variable lengths differ (found for 'sitef')}}\begin{alltt}
