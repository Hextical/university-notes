...
% \begin{noindent}
    ...
    neuro.dat
    neuro.dat$age <- factor(neuro.dat$age, levels = c(1,2,3), labels=c("0-11","12-23","24+"))
    neuro.dat$stage <- factor(neuro.dat$stage, levels = c(1,2,3,4,5), labels=c("I","II","III","IV","V"))
    @
% \end{noindent}
