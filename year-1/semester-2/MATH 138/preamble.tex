...
\DeclarePairedDelimiterXPP{\LOG}[1]{\mathrm{log}}(){}{#1}
\DeclarePairedDelimiterXPP{\LN}[1]{\mathrm{ln}}(){}{#1}
\DeclarePairedDelimiterXPP{\EXP}[1]{\mathrm{exp}}\{\}{}{#1}
...
\DeclarePairedDelimiterXPP\evalat[3]{}{\lbrack}\rbrack{_{#2}^{#3}}{#1}%
