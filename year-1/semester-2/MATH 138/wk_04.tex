    ...
    \begin{center}
        \begin{tikzpicture}
            \begin{axis}[ylabel = $y$, xlabel = $x$, x post scale=1.4]
                \addplot[blue, domain=0:3.2, name path=F] {x^2} node [pos = 0.9, left] {$y=x^2$};
                \addplot[red, domain=0:3.2, name path=G] {x} node [pos = 0.7, below] {$y=x$};
                \draw[-] (1,5) -- (1,0) node[below] {$x=1$};
    ...
    \begin{center}
        \begin{tikzpicture}
            \begin{axis}[ylabel = $y$, xlabel = $x$]
                \addplot[blue, domain=-1:1, name path=F] {1-x^2} node [pos = 0.5, above] {$y=1-x^2$};
                \addplot[red, domain=-1:1, name path=G] {x^2} node [pos = 0.5, below] {$y=x^2$};
                \draw[-] ($ ({1/sqrt(2)}, 1) $) -- ($ ({1/sqrt(2)}, 0) $) node[above] {$x=\frac{1}{\sqrt{2}}$};
                \draw[-] ($ ({-1/sqrt(2)}, 1) $) -- ($ ({-1/sqrt(2)}, 0) $) node[above] {$x=-\frac{1}{\sqrt{2}}$};
    ...
    \begin{center}
        \begin{tikzpicture}
            \begin{axis}[ylabel = $y$, xlabel = $x$, x post scale=1.4,
                ...
                \addplot[blue, domain=0:pi, name path=F] {sin(deg(x))} node [pos = 0.5, above] {$y=\sin x$};
...
\begin{Example}{}{}
    ...
    \begin{center}
        \begin{tikzpicture}
            \begin{axis}[ylabel = $y$, xlabel = $x$, x post scale=1.4]
                \addplot[blue, domain=1:5, name path=F] {sqrt(x-1)} node [pos = 0.8, below] {$x=y^2+1$};
                \addplot[blue, domain=1:5] {-sqrt(x-1)};
                \addplot[red, domain=0:2, name path=G] {x} node [pos = 0.5, left] {$y=x$};
                \addplot[black, domain=0:5] {0} node [pos = 0, below] {$y=0$};
                \addplot[black, domain=0:5] {2} node [pos = 0, above] {$y=2$};
