...
\textbf{\myuline{Chapter 4: Probability Rules and Conditional Probability}}

\myuline{4.1 General Methods}

$ {\color{blue} A}\cup {\color{red} B} $

\scalebox{0.5}{\input{union.pdf_tex}}

$ {\color{purple} A\cap B }$

\scalebox{0.5}{\input{intersection.pdf_tex}}

$ {\color{purple}\overline{A\cup B}}={\color{blue}\overline{A}}\cap {\color{red}\overline{B}} $

\scalebox{0.5}{\input{complement.pdf_tex}}
...
\myuline{4.2 Rules for Unions of Events}
