...
Suppose two variables $ X $ and $ Y $ have \myuline{non-zero} covariance.
What can we say?

a) $ X $ and $ Y $ are independent. b) $ X $ and $ Y $ are not independent.
c) we cannot tell if they are independent.

Same question, but for \myuline{zero} covariance.
...
\myuline{Rules of Linear Combinations}
...
\myuline{Normal random variables
}
...
Find the probability the \myuline{average height} of 5 cats is within 1cm of average.
