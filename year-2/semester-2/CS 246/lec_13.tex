...
\end{lstlisting}
\code{cout <{}< v1;} \textrightarrow{} cannot be implemented within the method as with
\code{cin >{}> v2;}
\code{.h}
\begin{lstlisting}
...
\begin{itemize}
    ...
    \item \code{operator()} \textrightarrow{} allows you treat an object as a function
    \item \code{operator T()} \textrightarrow{} allows you to implicitly convert
