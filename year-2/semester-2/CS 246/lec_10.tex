...
\end{itemize}
File: \code{example4} \textrightarrow{} fixes the issue above
...
\end{lstlisting}
\code{std::ostream} \textrightarrow{}
...
\code{Student Bobby = \{75,50,65\}} \textrightarrow{} not going to use this syntax,
but it's allowed.
