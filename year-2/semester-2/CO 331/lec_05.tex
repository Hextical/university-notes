...
\myuline{Question:} For what $ n\in\mathbb{Z}_{\geqslant 2} $ do there exists
finite fields of order $ n $? If a field of order $ n $ exists, how do
we ``construct'' it?

\myuline{Recall:} Let $ n\geqslant 2 $. The integers modulo $ n $,
...
\myuline{Question:} Do there exist finite fields of orders $ 4 $ and $ 6 $?
...
\myuline{Roadmap:} Let $ F $ be a finite field of order $ n $.
