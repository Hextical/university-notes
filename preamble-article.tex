...
% Statistics
% \DeclarePairedDelimiterXPP{〈cmd〉}[〈num args〉]
%   {〈pre code〉}{〈left_delim〉}{〈right_delim〉}{〈post code〉}{〈body〉}
\DeclarePairedDelimiterXPP{\E}[1]{\text{E}}[]{}{#1}
\DeclarePairedDelimiterXPP{\Var}[1]{\text{Var}}(){}{#1}
